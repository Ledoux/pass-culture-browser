...
class Typeform extends PureComponent {
  ...
  displayEmbeddedTypeform = () => {
    const queryParams = queryString.stringify({
      userId: this.props.culturalSurveyId, // legacy issue : the query param userId is not the actual `user.id`
  ...
  onSubmitTypeform = async () => {
    ...
    await this.props.updateCurrentUser({
      culturalSurveyId: this.props.culturalSurveyId,
...
Typeform.propTypes = {
  culturalSurveyId: PropTypes.string.isRequired,
